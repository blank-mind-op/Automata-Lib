...
# Define the grid size and simulation parameters
# Parameters
...
anim = FuncAnimation(fig, update, frames=range(days), interval=interval, repeat=False)


anim.save('simulation2.mp4', writer=Writer, dpi=600)
